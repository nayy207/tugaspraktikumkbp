...
const playlistId = localStorage.getItem("playlistId") || '6a0beCUJi9VRAqFJIQrapI';
...
function createSpotifyEmbed(id) {
    ...
    iframe.src = `https://open.spotify.com/embed/playlist/${id}?utm_source=generator&theme=0`;  // Fix the template literal
    iframe.width = "100%";
    iframe.height = "360";
